...
export function createInitialCriteria(options?: { enableSensitiveCriteria?: boolean }): ListCriteria {
  ...
  return {
    ...
    predictive: {
      selectedCriteria: [],
      lifestylePredictors: {
        homeImprovement: 'no-preference',
        autoShopping: 'no-preference',
        investmentInterest: 'no-preference',
        healthConsciousness: 'no-preference',
        technologyAdoption: 'no-preference',
      },
      financialBehavior: {
        creditSeeker: 'no-preference',
        bigTicketShopper: 'no-preference',
        onlineShopper: 'no-preference',
        brandLoyal: 'no-preference',
      },
      propertyBehavior: {
        likelyToMove: 'no-preference',
        likelyToRefinance: 'no-preference',
        likelyToSell: 'no-preference',
        homeEquityUser: 'no-preference',
      },
      communicationPreferences: {
        responsiveToDirectMail: 'no-preference',
        responsiveToEmail: 'no-preference',
        responsiveToPhone: 'no-preference',
        socialMediaActive: 'no-preference',
      },
    },
    options: {
      selectedCriteria: [],
