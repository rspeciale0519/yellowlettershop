    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6 py-0 my-2.5">
        <Link href="/" className="flex items-center gap-2">
          ...
          />
          <Image src="/yls-logo-icon.png" alt="Yellow Letter Shop Logo" width={32} height={32} className="sm:hidden" />
        </Link>
        ...
        <div className="flex items-center gap-4">
          {!isLoading && (
            <>
              {user ? (
                <>
                  <Button asChild className="hidden sm:inline-flex bg-yellow-500 hover:bg-yellow-600 text-gray-900">
