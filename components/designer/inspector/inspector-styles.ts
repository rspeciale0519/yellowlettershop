...
export const controlClass =
  "h-10 border-slate-700 bg-slate-950/70 text-white placeholder:text-slate-500 focus-visible:ring-yellow-400"
export const selectClass = `${controlClass} w-full rounded-md border px-3 text-sm`
export const labelClass = "text-[11px] font-semibold uppercase tracking-wide text-slate-400"
