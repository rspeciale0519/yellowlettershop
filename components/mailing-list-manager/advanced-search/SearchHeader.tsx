...
interface SearchHeaderProps {
  ...
  id?: string;
export function SearchHeader({ isOpen, id, labelledById, className }: SearchHeaderProps) {  labelledById?: string;
  /** Optional additional classes for the outer container */
  className?: string;
}
export function SearchHeader({ isOpen }: SearchHeaderProps) {
  return (
    <div
      <div className="bg-card rounded-md p-3 pt-2">
        <div className="mb-4 text-sm">
          <h3 id={labelledById} className="text-base font-bold mb-1">Advanced Search</h3>
        ...
        </div>          <h3 className='text-base font-bold mb-1'>Advanced Search</h3>
          <p className='mb-2'>
