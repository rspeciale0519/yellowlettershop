// ---------------------------------------------------------------------------
// Hand-authored DOMAIN types, restored verbatim from the pre-consolidation
// types/supabase.ts (deleted in 4f7229c; the regenerated schema file dropped
// them). The legacy Database interface was intentionally NOT carried over —
// the generated Database in ./supabase.ts is canonical. supabase.ts
// selectively re-exports the non-colliding names below. B8:
